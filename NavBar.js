    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
            <a class="nav-link" href="HomeSeite.html">
        ...
        <!-- Kategorien -->
        <li class="nav-item">
             <a class="nav-link" href="KategorieSeite.html">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a class="dropdown-item" href="#">
                <div class="form-group">
                  <!-- Nutzername -->
                  <label for="exampleDropdownFormEmail2"> Nutzername </label>
                  <input type="email" class="form-control" id="exampleDropdownFormEmail2" placeholder="examplename">
                </div>
