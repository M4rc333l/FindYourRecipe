...
$User_ID = $_SESSION['id'];
$RezeptID = $_GET['id'];
$stmt = $dbh->prepare("UPDATE User SET FavoritenRezepte = CONCAT(FavoritenRezepte,',',$RezeptID) WHERE UserID = '$User_ID'AND FavoritenRezepte IS NOT NULL AND FavoritenRezepte <> '';");
$stmt->execute();
